  ...
  return (
    ...
    >
      ...
      <p>
        ...
        assignment, I felt like it is possible to answer the question: “What is
        the difference in total U.S population between 1900 and 2000?” The
        visualization I chose to represent the U.S Population data is a stacked
        bar chart comparing the total population of the two years with each bar
        representing different age ranges. I believe that this visualization
        best showcase how much more people we have in the 2000 compared to 1900
        and also how much life expectancy has increased. The amount of people
        over 80 years old (represented in light green bars) are much higher in
      ...
      <div>
        ...
        <p>
          ...
          bar charts, line charts, pie charts, and area charts. Starting off, I
          knew a bar chart showcasing the total number of passengers in each
          terminal would be the best overall visualization for this dataset
          allowing us to compare how much passenger traffic each terminal has
          been handling over the years. I have decided to divided each bar into
          2 stacks to reveal how many passenger in each terminal are
          international or domestic passenger.
        </p>
        <p>
          With the given data, some visualizations are more benefitial when
          colors are used to help differentiate the different categories. In the
          area chart and pie chart showing differences in numbers between
          multiple terminals, color helps us visually differentiate each
          terminal and is more effective than if if the visualization is done in
          grayscale.
        </p>
        <p
          style={{
        ...
        >
          Another chart that I believe revealed important insight is the various
          pie charts visualizing the ratio between total domestic and
        ...
        <ul>
          <li>Which terminal is overall the busiest at LAX?</li>
          <li>How has LAX handle international and domestic passengers?</li>
          <li>How has COVID-19 affected passenger traffic at LAX?</li>
        </ul>
        <img
          src={BarChart}
          style={{
        ...
        >
          ...
          each year revealed the closure of Terminal 3 (dark green) in 2020 and
          the lack of recovery from the pandemic in some terminals like Terminal
          1 (bright orange), Terminal 4 (light green), and TBIT (red) which
          hasn't fully grown back to its pre-pandemic traffic numbers.
        </p>
        <img
          src={DomVsIntlPie}
          style={{
      ...
      <div>
        <h1>Assignment 3</h1>
        <h2>Los Angeles International Airport Passenger Share By Terminal</h2>
        <p>
          For project 3, I have decided to work on making an interactive
          visualization that answers a simple question: How is passenger traffic
          at LAX divided? My interactive graphic is mainly a pie chart that
          represents each terminal’s average passenger share. When the user
          clicks on each slice, additional information appears for them below
          the pie chart showcasing numerical data of average passenger count and
        ...
        <p>
          ...
          unfamiliar with working with the useState function.
        </p>
        <Pie />
      </div>
    </div>
